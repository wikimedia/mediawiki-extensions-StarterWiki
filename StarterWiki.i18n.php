 ...
 */
$messages['en'] = array(
	'starterwiki-desc' => 'Provides a set of maintenance scripts and functions to allow for creation of wiki databases based off a starter wiki',
);
 ...
 */
$messages['qqq'] = array(
	'starterwiki-desc' => '{{desc|name=Starter Wiki|url=http://www.mediawiki.org/wiki/Extension:StarterWiki}}',
);
 ...
 */
$messages['ast'] = array(
	'starterwiki-desc' => 'Ufre un conxuntu de scripts y funciones de mantenimientu pa permitir crear bases de datos wiki basaes nuna wiki de partida',
);
